...
select MainCode from FINMIG..ForAcidLAA where LoanType in ('EMI', 'NONEMI'))
...
/*
insert into 
FINMIG..PastDue (BranchCode, ReferenceNo, Flow_ID, IntOverDues, IntOnIntOverDues, IntOnPriOverDues,
PriOverDues, Remarks, dmd_date)
values('002', '00203300022008000005', 'PRDEM', '0.00', '0.00', '0.00', '1200000.00','', '2020-08-29')
00104200017162000001

insert into 
FINMIG..PastDue (BranchCode, ReferenceNo, Flow_ID, IntOverDues, IntOnIntOverDues, IntOnPriOverDues,
PriOverDues, Remarks, dmd_date)
values('001', '00104200017162000001', 'PRDEM', '0.00', '0.00', '0.00', '1900000.00','', '2020-07-14')
