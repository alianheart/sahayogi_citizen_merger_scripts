...
--and ReferenceNo = '00103800055300000002'
...
where FLOWID='PIDEM' --and ReferenceNo = '00103800055300000002'
...
from FINMIG.dbo.PastDue t1 join 
FINMIG.dbo.LOAN_OVERDUE_PENAL t2 on t1.ReferenceNo=t2.MainCode
where FLOWID='INDEM' --and ReferenceNo = '00103800055300000002'
group by BranchCode,t1.ReferenceNo,Flow_ID,diffint
)x
--select * from #loan_temp where ReferenceNo = '01003300079609000002'
...
--where t1.MainCode = '01003300079609000002'
